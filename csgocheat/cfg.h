...
public:
	...
	void Setup()
	{
		...
		SetupValue(Vars.Ragebot.CustomYaw, TRUE, "RAGEBOT", "CUSTOM_YAW");
		SetupValue(Vars.Ragebot.Hitscan.PointScale, TRUE, "RAGEBOT", "POINT_SCALE");
		...
		SetupValue(Vars.Ragebot.SlowwalkOn, TRUE, "SLOWWALK", "SLOWwALK_GAY");
		SetupValue(Vars.Ragebot.Resolver, TRUE, "RESOLVER", "RESOLVER_ON");
		SetupValue(Vars.Ragebot.Grayscale, FALSE, "VISUALS", "GRAYSCALE");
		SetupValue(Vars.Ragebot.Slidewalk, TRUE, "RAGEBOT", "SLIDEWALK");



		//legit values
		SetupValue(Vars.Ragebot.LegitFov, FALSE, "LEGITBOT", "FOV");
		SetupValue(Vars.Ragebot.LegitSilent, FALSE, "LEGITBOT", "SILENT");
		SetupValue(Vars.Ragebot.LegitFriendlyFire, FALSE, "LEGITBOT", "FF");
		SetupValue(Vars.Ragebot.LegitTriggerBot, FALSE, "LEGITBOT", "TRIGGERBOT");
		SetupValue(Vars.Ragebot.LegitSmooth, FALSE, "LEGITBOT", "SMOOTH");
		SetupValue(Vars.Ragebot.LegitHitbox, FALSE, "LEGITBOT", "HITBOX");
		SetupValue(Vars.Ragebot.LegitRCSAmt, FALSE, "LEGITBOT", "RCS_VAL");
		SetupValue(Vars.Ragebot.LegitRandomizeAmt, FALSE, "LEGITBOT", "HUMANIZE_VAL");
		SetupValue(Vars.Ragebot.LegitTriggerKey, FALSE, "LEGITBOT", "TRIGGER_KEY");
		SetupValue(Vars.Ragebot.LegitTriggerBotEnb, FALSE, "LEGITBOT", "TRIGGER_ENB");
		SetupValue(Vars.Ragebot.LegitSmoothVariablation, FALSE, "LEGITBOT", "MORE_HUMANIZE");
		...
		SetupValue(Vars.Ragebot.EdgeJump, TRUE, "MOVEMENT", "EDGEJUMP");
