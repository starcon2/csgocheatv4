...
public:
	...
	static void DoEsp()
	{
		...
		static int vx, vy, vz;
		static ConVar* view_x = Interfaces.g_ICVars->FindVar("viewmodel_offset_x");
		static ConVar* view_y = Interfaces.g_ICVars->FindVar("viewmodel_offset_y");
		static ConVar* view_z = Interfaces.g_ICVars->FindVar("viewmodel_offset_z");
